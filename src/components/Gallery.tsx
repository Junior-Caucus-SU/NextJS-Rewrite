...
import Elias_Xu from "/public/static/images/people/Elias_Xu.jpg";
import Emily_Li from "/public/static/images/people/Emily_Li.jpeg";
import Ethan_Sie from "/public/static/images/people/Ethan_Sie.jpg";
import Grace_Rhee from "/public/static/images/people/Grace_Rhee.jpeg";
import Josephine_Gunawan from "/public/static/images/people/Josephine_Gunawan.jpeg";
import Maegan_Diep from "/public/static/images/people/Maegan_Diep.jpeg";
import Stacie_Au from "/public/static/images/people/Stacie_Au.jpeg";
import Josephine_Yoo from "/public/static/images/people/Josephine_Yoo.png";
import Will from "/public/static/images/people/Will.png";
import John from "/public/static/images/people/John.jpeg";
import Vicki_Chen from "/public/static/images/people/Vicki_Chen.png";
...
export default function Gallery() {
    useEffect(() => {
        const handleScroll = () => {
            ...
            if (meetText !== null) {
                (meetText as HTMLElement).style.transform = `translateX(${transformPercentage * 100}%)`;
                (teamText as HTMLElement).style.transform = `translateX(-${transformPercentage * 100}%)`;
            }
        };
        ...
        const handleScroll = () => {
            [pres1Ref, pres2Ref].forEach((ref) => {
                if (ref.current) {
                    ...
                    // Transform
                    (ref.current as HTMLElement).style.transform = `scale(${zoom})`;
                }
            });
        };
        ...
        <div className="people-page-body">
            ...
            <div className="chiefs people-section">
                ...
                <div className="chiefs-box box">
                    <div className="to-fade-in">
                        <div className="chiefs-box-text box-text">
                            Chiefs <i>of</i> Staff
                        </div>
                    </div>
                </div>
                        ...
                        <div className="subgroup-containerD">
                            <div className="d_type_box">
                                <div className="director person-container chenming to-fly-from-left">
                                    ...
                                    <Image src={Chenming_Fang} alt="" className="director-img" />
                    ...
                    <div className="subgroup-containerD">
                        <div className="d_type_box">
                            <div className="director person-container elias to-fly-from-left">
                                ...
                                <Image src={Elias_Xu} alt="" className="director-img" />
                            ...
                            <div className="director person-container to-fly-from-right">
                                <Image src={Will} alt="" className="director-img" />
                    ...
                    <div className="subgroup-containerD">
                        <div className="d_type_box">
                            <div className="director person-container stacie to-fly-from-left">
                                ...
                                <Image src={Stacie_Au} alt="" className="director-img" />
                            ...
                            <div className="director person-container to-fly-from-left">
                                <Image src={Ayla_Irshad} alt="" className="director-img" />
                    ...
                    <div className="subgroup-containerD">
                        <div className="d_type_box_c chloe">
                            <div className="director person-container to-fly-from-right">
                                ...
                                <Image src={Chloe_Wong} alt="" className="director-img" />
                        ...
                        <div className="director person-container to-fly-from-right">
                            <Image src={Vicki_Chen} alt="" className="director-img" />
                        ...
                        <div className="d_type_box_c">
                            <div className="director person-container to-fly-from-left">
                                ...
                                <Image src={Maegan_Diep} alt="" className="director-img " />
                                ...
                                <div className="description">
                                    ...
                                    fact: I&apos;ve been to Dominican Republic/static four times... (I
...
const calculateZoom = (element: HTMLElement | null): number => {
    if (!element) return 1; // if the element is not defined

    const viewportHeight: number = window.innerHeight;
    const rect: DOMRect = element.getBoundingClientRect();
    const elementCenter: number = rect.top + rect.height / 2;
    const distanceFromCenter: number = Math.abs(viewportHeight / 2 - elementCenter);
    const maxDistance: number = viewportHeight / 3; // max dist from the center

    // calculate the zoom level - closer to center means more zoom
    const zoomLevel: number = 1 + (1 - distanceFromCenter / maxDistance) * 0.1; // controls max zoom
